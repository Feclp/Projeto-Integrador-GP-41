...
Desenvolvimento Low Code em Ciência
de Dados
...
Dashboard Estratégico de Vendas para Marketing

1. Contexto do Projeto
Este projeto tem como objetivo realizar o processo de ETL e Análise Exploratória de
Dados utilizando um dataset público disponível no Kaggle:
Fonte de dados:
https://www.kaggle.com/datasets/aliiihussain/amazon-sales-dataset
O dataset contém registros de transações de vendas da Amazon no período de 2022 -
2023, incluindo informações sobre id do pedido, data da venda, categorias de produto,
valor unitário, quantidade, região da compra, método de pagamento e avaliação do
produto.
...
• Em quais períodos ocorrem picos de vendas
• A média de desconto e avalição dos produtos
• Storyteling para que a gestão consiga acompanhar essas informações de forma
clara.
...
• Resumo total das métricas apresentadas
